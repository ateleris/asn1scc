    ...
    inherit ILangGeneric()
        ...
        override this.RtlFuncNames : string list =
            [
                ...
                // ACN deferred patching functions (generated by DEFINE_ACN_DET_ENCODERS macros).
                // These are static inline in the header; including them in RtlFuncNames
                // ensures the RTL stripping keeps the base encoder functions they depend on.
                "Acn_InitDet_U8"
                "Acn_PatchDet_U8"
                "Acn_InitDet_U16_BE"
                "Acn_PatchDet_U16_BE"
        ...
        override this.detectFunctionCalls (sourceCode: string) (functionName: string) : string list =
            let knownCases =
                [
                    ...
                    // ACN deferred patching: InitDet/PatchDet are defined via DEFINE_ACN_DET_ENCODERS
                    // macros (not parseable by regex).  Declare the base encoder function as a
                    // known dependency so RTL stripping keeps it (and the macro instantiation).
                    ("Acn_InitDet_U8",     ["Acn_Enc_Int_PositiveInteger_ConstSize_8"])
                    ("Acn_PatchDet_U8",    ["Acn_Enc_Int_PositiveInteger_ConstSize_8"])
                    ("Acn_InitDet_U16_BE", ["Acn_Enc_Int_PositiveInteger_ConstSize_big_endian_16"])
                    ("Acn_PatchDet_U16_BE",["Acn_Enc_Int_PositiveInteger_ConstSize_big_endian_16"])
                    ("Acn_InitDet_U32_BE", ["Acn_Enc_Int_PositiveInteger_ConstSize_big_endian_32"])
                    ("Acn_PatchDet_U32_BE",["Acn_Enc_Int_PositiveInteger_ConstSize_big_endian_32"])
                    ("Acn_InitDet_U64_BE", ["Acn_Enc_Int_PositiveInteger_ConstSize_big_endian_64"])
                    ("Acn_PatchDet_U64_BE",["Acn_Enc_Int_PositiveInteger_ConstSize_big_endian_64"])
                    ("Acn_InitDet_U16_LE", ["Acn_Enc_Int_PositiveInteger_ConstSize_little_endian_16"])
                    ("Acn_PatchDet_U16_LE",["Acn_Enc_Int_PositiveInteger_ConstSize_little_endian_16"])
                    ("Acn_InitDet_U32_LE", ["Acn_Enc_Int_PositiveInteger_ConstSize_little_endian_32"])
                    ("Acn_PatchDet_U32_LE",["Acn_Enc_Int_PositiveInteger_ConstSize_little_endian_32"])
                    ("Acn_InitDet_U64_LE", ["Acn_Enc_Int_PositiveInteger_ConstSize_little_endian_64"])
                    ("Acn_PatchDet_U64_LE",["Acn_Enc_Int_PositiveInteger_ConstSize_little_endian_64"])
                    ("Acn_InitDet_I8",     ["Acn_Enc_Int_TwosComplement_ConstSize_8"])
                    ("Acn_PatchDet_I8",    ["Acn_Enc_Int_TwosComplement_ConstSize_8"])
                    ("Acn_InitDet_I16_BE", ["Acn_Enc_Int_TwosComplement_ConstSize_big_endian_16"])
                    ("Acn_PatchDet_I16_BE",["Acn_Enc_Int_TwosComplement_ConstSize_big_endian_16"])
                    ("Acn_InitDet_I32_BE", ["Acn_Enc_Int_TwosComplement_ConstSize_big_endian_32"])
                    ("Acn_PatchDet_I32_BE",["Acn_Enc_Int_TwosComplement_ConstSize_big_endian_32"])
                    ("Acn_InitDet_I64_BE", ["Acn_Enc_Int_TwosComplement_ConstSize_big_endian_64"])
        ...
        override this.getDeferredDetFunctions (acnType: Asn1AcnAst.AcnInsertedType) : DetFunctionNames option =
            let mapIntEncoding (enc: Asn1AcnAst.IntEncodingClass) : DetFunctionNames option =
                match enc with
                | Asn1AcnAst.PositiveInteger_ConstSize_8                -> Some ("Acn_InitDet_U8",     "Acn_PatchDet_U8", None, 0I)
                | Asn1AcnAst.PositiveInteger_ConstSize_big_endian_16    -> Some ("Acn_InitDet_U16_BE", "Acn_PatchDet_U16_BE", None, 0I)
                | Asn1AcnAst.PositiveInteger_ConstSize_big_endian_32    -> Some ("Acn_InitDet_U32_BE", "Acn_PatchDet_U32_BE", None, 0I)
                | Asn1AcnAst.PositiveInteger_ConstSize_big_endian_64    -> Some ("Acn_InitDet_U64_BE", "Acn_PatchDet_U64_BE", None, 0I)
                | Asn1AcnAst.PositiveInteger_ConstSize_little_endian_16 -> Some ("Acn_InitDet_U16_LE", "Acn_PatchDet_U16_LE", None, 0I)
                | Asn1AcnAst.PositiveInteger_ConstSize_little_endian_32 -> Some ("Acn_InitDet_U32_LE", "Acn_PatchDet_U32_LE", None, 0I)
                | Asn1AcnAst.PositiveInteger_ConstSize_little_endian_64 -> Some ("Acn_InitDet_U64_LE", "Acn_PatchDet_U64_LE", None, 0I)
                | Asn1AcnAst.TwosComplement_ConstSize_8                 -> Some ("Acn_InitDet_I8",     "Acn_PatchDet_I8", None, 0I)
                | Asn1AcnAst.TwosComplement_ConstSize_big_endian_16     -> Some ("Acn_InitDet_I16_BE", "Acn_PatchDet_I16_BE", None, 0I)
                | Asn1AcnAst.TwosComplement_ConstSize_big_endian_32     -> Some ("Acn_InitDet_I32_BE", "Acn_PatchDet_I32_BE", None, 0I)
                | Asn1AcnAst.TwosComplement_ConstSize_big_endian_64     -> Some ("Acn_InitDet_I64_BE", "Acn_PatchDet_I64_BE", None, 0I)
                | Asn1AcnAst.PositiveInteger_ConstSize nBits            -> Some ("Acn_InitDet_ConstSize", "Acn_PatchDet_ConstSize", Some nBits, 0I)
                | Asn1AcnAst.TwosComplement_ConstSize nBits             -> Some ("Acn_InitDet_TwosComplement_ConstSize", "Acn_PatchDet_TwosComplement_ConstSize", Some nBits, 0I)
                | _ -> None
            match acnType with
