...
from conftest import get_null_terminator_string, generate_ia5_string, generate_ia5_string_random_length


def _encode_and_decode_single_ia5_string(acn_encoder: ACNEncoder, input_string: str, min_length: int, max_length: int) -> tuple[bool, str]:
...
def _encode_and_decode_multiple_ia5_strings(acn_encoder: ACNEncoder, input_strings: list[str], min_length: int, max_length: int) -> tuple[bool, list[str]]:
    ...
    for input_number in input_strings:
        encoded_res = acn_encoder.enc_ia5_string_char_index_internal_field_determinant(max_length, min_length, input_number)
        if not encoded_res.success:
            return False, []
...
def _test_single_string(acn_encoder: ACNEncoder, input_string: str, min_length: int, max_length: int) -> None:
    ...
    success, decoded_value = _encode_and_decode_single_ia5_string(acn_encoder, input_string, min_length, max_length)
...
def _test_multiple_strings(acn_encoder: ACNEncoder, input_numbers: list[str], min_length: int, max_length: int) -> None:
    ...
    success, decoded_values = _encode_and_decode_multiple_ia5_strings(acn_encoder, input_numbers, min_length, max_length)
...
def test_enc_dec_ia5_string_char_index_internal_field_determinant_single_value(acn_encoder: ACNEncoder, seed: int, max_length: int) -> None:
    input_string: str = generate_ia5_string(max_length)
    _test_single_string(acn_encoder, input_string, 0, max_length)

def test_enc_dec_ia5_string_char_index_internal_field_determinant_single_value_random_range(acn_encoder: ACNEncoder, seed: int, max_length: int) -> None:
...
def test_enc_dec_ia5_string_char_index_internal_field_determinant_single_value_var_length(acn_encoder: ACNEncoder, seed: int, max_length: int) -> None:
    input_string: str = generate_ia5_string_random_length(max_length)
    _test_single_string_starts_with(acn_encoder, input_string, 0, max_length)

def test_enc_dec_ia5_string_char_index_internal_field_determinant_multiple_values(acn_encoder: ACNEncoder, seed: int, max_length: int) -> None:
...
def test_enc_dec_ia5_string_char_index_internal_field_determinant_zero_length(acn_encoder: ACNEncoder, seed: int, charset: str) -> None:
    input_string: str = ""
