...
from conftest import get_random_unsigned, get_unsigned_max, get_big_float, get_small_float, get_zero_and_special_floats
...
def _encode_and_decode_single_double(acn_encoder: ACNEncoder, input_number: float) -> tuple[bool, float]:
    """Helper function to encode and decode a single double value.
...
def _encode_and_decode_multiple_double(acn_encoder: ACNEncoder, input_numbers: list[float]) -> tuple[bool, list[float]]:
    """Helper function to encode and decode multiple double values.
...
def _test_single_double(acn_encoder: ACNEncoder, input_number: float) -> None:
    """Helper function to test encoding/decoding of a single double value."""

    success, decoded_value = _encode_and_decode_single_double(acn_encoder, input_number)
...
def _test_multiple_double(acn_encoder: ACNEncoder, input_numbers: list[float]) -> None:
    """Helper function to test encoding/decoding of multiple double values."""
    success, decoded_values = _encode_and_decode_multiple_double(acn_encoder, input_numbers)
    ...
    # TODO: this must be done with a threshold
