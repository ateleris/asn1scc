...
def test_enc_dec_string_ascii_null_terminated_single_value(acn_encoder: ACNEncoder, seed: int, max_length: int) -> None:
...
def test_enc_dec_string_ascii_null_terminated_multiple_values(acn_encoder: ACNEncoder, seed: int, max_length: int) -> None:
...
def test_enc_dec_string_ascii_null_terminated_too_long(acn_encoder: ACNEncoder, seed: int, max_length: int) -> None:
