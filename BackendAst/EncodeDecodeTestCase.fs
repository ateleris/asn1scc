...
let _createUperEncDecFunction (r:Asn1AcnAst.AstRoot) (lm:LanguageMacros) (t:Asn1AcnAst.Asn1Type) (typeDefinition:TypeDefinitionOrReference) (eqFunc:EqualFunction) (isValidFunc: IsValidFunction option) (encFunc : UPerFunction option) (decFunc : UPerFunction option)   (us:State)  =
    ...
    | Some funcName     ->
        ...
        let printStatement stm sNestedContent =
            let content=
                ...
                |Decode_output          -> option {
                                                ...
                                                return decode modName decFunName (typeDefinition.longTypedefName2 (Some lm.lg) lm.lg.hasModules) sEnc sAmberDecode
                                           }
        ...
        | true  ->
            ...
            let func =
                printCodec_body modName funcName (typeDefinition.longTypedefName2 (Some lm.lg) lm.lg.hasModules) sStar varName "" (sNestedStatements.orElse "") "UPER"
            let funcDef = printCodec_body_header funcName  modName (typeDefinition.longTypedefName2 (Some lm.lg) lm.lg.hasModules) sStar varName
            let ret =
                {
    ...
    | true  ->
        ...
        | Some funcName     ->
            ...
            | true  ->
                ...
                let func = printCodec_body modName funcName (typeDefinition.longTypedefName2 (Some lm.lg) lm.lg.hasModules) sStar varName sEnc (sNestedStatements.orElse "") "ACN"
                let funcDef = printCodec_body_header funcName modName (typeDefinition.longTypedefName2 (Some lm.lg) lm.lg.hasModules) sStar varName
...
let _createXerEncDecFunction (r:Asn1AcnAst.AstRoot) (lm:LanguageMacros) (t:Asn1AcnAst.Asn1Type) (typeDefinition:TypeDefinitionOrReference) (eqFunc:EqualFunction) (isValidFunc: IsValidFunction option) (encFunc : XerFunctionRec) (decFunc : XerFunctionRec)   (us:State)  =
    ...
    | Some funcName     ->
        ...
        let func = printCodec_body modName funcName (typeDefinition.longTypedefName2 (Some lm.lg) lm.lg.hasModules) sStar varName sEnc (sNestedStatements.orElse "")
        let funcDef = printCodec_body_header funcName  modName (typeDefinition.longTypedefName2 (Some lm.lg) lm.lg.hasModules) sStar varName
        let ret =
            {
                EncodeDecodeTestFunc.funcName   = funcName
